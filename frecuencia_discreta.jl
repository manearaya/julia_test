...
# ╔═╡ 4880cae0-67ac-11ee-2ded-21c4716f8a38
using PlutoUI, Plots, LaTeXStrings

# ╔═╡ 5a4e521a-1871-41e0-89db-93a801a7e88a
@bind omega html"""
<input type=range min=0 max=12.566 step=0.0001 value=0 style='width: 100%;' oninput='this.nextElementSibling.value=this.value;'>
<output>0</output>
"""

# ╔═╡ 9530a0aa-281a-44be-be68-77f81dce1506
md"""
### $\omega$ = $(omega)"""

# ╔═╡ 6f8c1201-e45f-45ce-b21d-cf355552b863
begin
	n = collect(-15:1:15)
	plot(n, cos.(omega .* n), legend = false, title = L"\cos(%$omega \cdot n )", line = :stem, marker = :circle, size = (800, 500), ylims =[ -1.2,1.2])
end
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "41e3e0eb0eae910bee1922cf787a209faae04c34"
